...
# ai-integrity-check — AI/ML Paper Integrity Verifier
...
| Use ai-integrity-check when | Use a different skill when |
|---|---|
| You have a draft and want pre-submission audit | You're still drafting → `ai-paper-writer` |
| You want citation verification | You need to find new citations → `ai-lit-scout` |
| You want pre-flight check before reviewers see it | You want a peer review → `ai-paper-reviewer` |
...
- Verification failures → `ai-paper-writer revise mode` (to fix in prose)
- Missing citations → `ai-lit-scout` (to find them)
- Reproducibility gaps → `ai-venue-formatter` (to fill checklist before submission)

## See Also

- `ai-paper-writer` — drafts that go through this skill
- `ai-lit-scout` — finds replacement citations for unverifiable ones
- `ai-paper-reviewer` — invokes ai-integrity-check as part of full review
- `ai-rebuttal-coach` — invokes ai-integrity-check before rebuttal claims about new experiments
