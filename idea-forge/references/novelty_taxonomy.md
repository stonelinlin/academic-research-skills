...
There is no single thing called "novelty". Reviewers use at least 5 distinct senses, often without naming which one. idea-forge scores against the strongest applicable type.
