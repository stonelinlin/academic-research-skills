...
- /lit-scout for full bibliography
- /related-positioning to nail differentiation vs RULER and LongBench v2
- /method-architect to design the controlled benchmark construction

State saved as session-20260420-1431-idea-forge. Resume anytime.
```
