...
# idea-forge — AI/ML Research Idea Generator
...
| Use idea-forge when | Use a different skill when |
|---|---|
| You have an interest area but no specific RQ | You already have an RQ → `lit-scout` |
| You want novelty estimates against existing work | You want to position vs specific papers → `related-positioning` |
| You need to choose between candidate directions | You're ready to design experiments → `method-architect` |
...
```
"Resume idea-forge from yesterday."
...
```
→ lit-scout            "Find papers I should cite for idea-003"
→ related-positioning  "Position idea-003 vs RULER and LongBench"
→ method-architect     "Design experiments for idea-003"
```
