...
**Fix**: Use related-positioning skill. Add a sentence in the rebuttal that ARTICULATES the differentiation, not just promises a citation.
...
**Fix**: integrity-check skill on rebuttal claims involving citations.
