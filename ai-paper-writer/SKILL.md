...
# ai-paper-writer — AI/ML Paper Section Drafter
...
| Use ai-paper-writer when | Use a different skill when |
|---|---|
| You're drafting paper sections | You're writing a rebuttal → `ai-rebuttal-coach` |
| You need an abstract or intro | You need to design the experiment first → `ai-method-architect` |
| You're polishing/revising prose | You need a full peer review → `ai-paper-reviewer` |
...
- Draft → `ai-figure-smith` (when section references figures that don't exist yet)
- Draft → `ai-integrity-check` (verify citation and factual claims)
- Draft → `ai-venue-formatter` (compile to LaTeX + venue template)
- Draft → `ai-paper-reviewer` (self-review before sending to coauthors)

## See Also

- `ai-lit-scout` — supplies bibliography for citations
- `ai-related-positioning` — supplies related-work section content
- `ai-figure-smith` — supplies figures referenced by the prose
- `ai-integrity-check` — verifies the draft post-hoc
- `ai-venue-formatter` — final compile to venue style
