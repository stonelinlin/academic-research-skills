...
# figure-smith — AI/ML Paper Figure & Table Smith
...
| Use figure-smith when | Use a different skill when |
|---|---|
| You have data and need a publication-quality figure | You need data analysis itself → external (pandas, etc.) |
| You're writing captions and alt text | You're drafting paper prose → `paper-writer` |
| You want VLM verification of an existing figure | You need full integrity audit → `integrity-check` |
...
| Agent | Role | File |
|---|---|---|
| `visualization_agent` | Core chart generation + design | [`academic-paper/agents/visualization_agent.md`](../academic-paper/agents/visualization_agent.md) |

## Key Protocols

- [`academic-paper/references/vlm_figure_verification.md`](../academic-paper/references/vlm_figure_verification.md) — VLM-based rendering audit
- [`academic-paper/references/visualization_quality.md`](../academic-paper/references/visualization_quality.md) — quality checklist
...
- `paper-writer` — inserts figure references in prose
- `venue-formatter` — compiles figures into the venue template
- `integrity-check` — verifies figure data matches reported numbers
