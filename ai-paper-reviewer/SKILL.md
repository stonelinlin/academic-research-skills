...
# ai-paper-reviewer — AI Venue Multi-Perspective Reviewer
...
| Use ai-paper-reviewer when | Use a different skill when |
|---|---|
| You want pre-submission review simulation | You have actual reviews to respond to → `ai-rebuttal-coach` |
| You want venue-format scoring | You want quick fact-check → `ai-integrity-check` |
...
OpenReview format with discussion threading hints (ai-rebuttal-coach friendly).
...
| Agent | Role | File |
|---|---|---|
| `field_analyst_agent` | Identify sub-area, calibrate severity | [`shared/agents/field_analyst_agent.md`](../shared/agents/field_analyst_agent.md) |
| `methodology_reviewer_agent` | Methods rigor | [`shared/agents/methodology_reviewer_agent.md`](../shared/agents/methodology_reviewer_agent.md) |
| `domain_reviewer_agent` | Sub-field expertise | [`shared/agents/domain_reviewer_agent.md`](../shared/agents/domain_reviewer_agent.md) |
| `perspective_reviewer_agent` | Underrepresented angle (e.g., applied / theoretical) | [`shared/agents/perspective_reviewer_agent.md`](../shared/agents/perspective_reviewer_agent.md) |
| `devils_advocate` (shared) | Adversarial critique | [`shared/agents/devils_advocate.md`](../shared/agents/devils_advocate.md) |
| `eic_agent` | EIC synthesis | [`shared/agents/eic_agent.md`](../shared/agents/eic_agent.md) |
| `editorial_synthesizer_agent` | Final meta-review compilation | [`shared/agents/editorial_synthesizer_agent.md`](../shared/agents/editorial_synthesizer_agent.md) |
...
6. **Block if ai-integrity-check finds critical issues.** Optionally, ai-paper-reviewer auto-invokes ai-integrity-check before review.
...
| `methodology-focus` | user wants rigor check | Methodology reviewer + ai-integrity-check |
...
- Review reports → `ai-rebuttal-coach` (when actual reviews come in, predict overlap)
- Critical concerns → `ai-paper-writer revise mode` (to address)
- Reviewer-threat patterns → `ai-paper-writer` (preempt in next draft)

## See Also

- `ai-integrity-check` — invoked before review for fact-finding
- `ai-rebuttal-coach` — when actual review arrives
